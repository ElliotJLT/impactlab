// DROP-IN REFERENCE for the app's dream route.
//   cp prompts/route.reference.ts app/api/dream/route.ts
//   cp prompts/dream.generated.ts lib/dream.ts        (fix the import below)
//   npm i @anthropic-ai/sdk
//
// Implements docs/API.md exactly. Falls back to the committed known-good
// response if the API errors or times out, so a wifi drop can't kill the demo.
